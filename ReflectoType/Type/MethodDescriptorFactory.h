...
namespace Reflecto
{
	namespace Reflection
	{
		...
		{
		public:
			using method_ptr_t = void (object_t::*)(args_t ...);
			...
			{
				MethodDescriptor::method_ptr_t<object_t, args_t...> method_wrapper = [methodPointer = _methodPointer] (object_t& obj, args_t ... args) {
					std::invoke(methodPointer, obj, args...);
				};
